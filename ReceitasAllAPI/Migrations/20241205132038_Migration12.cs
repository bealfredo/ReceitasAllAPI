...
// Type: ReceitasAllAPI.Migrations.Migration12
...
namespace ReceitasAllAPI.Migrations
{
  ...
  [Migration("20241205132038_Migration12")]
  public class Migration12 : Migration
  {
    ...
    {
      migrationBuilder.DropForeignKey("FK_FavoriteRecipes_Authors_AuthorId", "FavoriteRecipes");
      migrationBuilder.AddForeignKey("FK_FavoriteRecipes_Authors_AuthorId", "FavoriteRecipes", "AuthorId", "Authors", principalColumn: "ID");
    }
    ...
    {
      migrationBuilder.DropForeignKey("FK_FavoriteRecipes_Authors_AuthorId", "FavoriteRecipes");
      migrationBuilder.AddForeignKey("FK_FavoriteRecipes_Authors_AuthorId", "FavoriteRecipes", "AuthorId", "Authors", principalColumn: "ID", onDelete: ReferentialAction.Restrict);
    }
