...
// Type: ReceitasAllAPI.Migrations.Migration11
...
namespace ReceitasAllAPI.Migrations
{
  ...
  [Migration("20241205114001_Migration11")]
  public class Migration11 : Migration
  {
    ...
    {
      migrationBuilder.CreateTable("FavoriteRecipes", table => new
      {
        ID = table.Column<int>("int").Annotation("SqlServer:Identity", (object) "1, 1"),
        AuthorId = table.Column<int>("int"),
        RecipeId = table.Column<int>("int"),
        DateAdded = table.Column<DateTime>("datetime2")
      }, constraints: table =>
      {
        table.PrimaryKey("PK_FavoriteRecipes", x => x.ID);
        table.ForeignKey("FK_FavoriteRecipes_Authors_AuthorId", x => x.AuthorId, "Authors", "ID", (string) null, ReferentialAction.NoAction, ReferentialAction.Restrict);
        table.ForeignKey("FK_FavoriteRecipes_Recipes_RecipeId", x => x.RecipeId, "Recipes", "ID", (string) null, ReferentialAction.NoAction, ReferentialAction.Cascade);
      });
      migrationBuilder.CreateIndex("IX_FavoriteRecipes_AuthorId", "FavoriteRecipes", "AuthorId");
      migrationBuilder.CreateIndex("IX_FavoriteRecipes_RecipeId", "FavoriteRecipes", "RecipeId");
    }

    /// <inheritdoc />
    protected override void Down(MigrationBuilder migrationBuilder)
    {
      migrationBuilder.DropTable("FavoriteRecipes");
    }
    ...
    protected override void BuildTargetModel(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity("ReceitasAllAPI.Entities.FavoriteRecipe", (Action<EntityTypeBuilder>) (b =>
      {
        b.HasOne("ReceitasAllAPI.Entities.Author", "Author").WithMany("FavoriteRecipes").HasForeignKey("AuthorId").OnDelete(DeleteBehavior.Restrict).IsRequired();
